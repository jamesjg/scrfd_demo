...
if __name__ == '__main__':
    ...
    landmark_paths = ["/mnt/data/lanxing/UTK-face-wild/landmarks_utkface/landmark_list_part1.txt",
                       "/mnt/data/lanxing/UTK-face-wild/landmarks_utkface/landmark_list_part2.txt", 
                       "/mnt/data/lanxing/UTK-face-wild/landmarks_utkface/landmark_list_part3.txt"]
    filepaths = []

    for landmark_path in landmark_paths:
        with open(landmark_path, 'r') as f:
            content = f.readlines()
            part_filepaths = [line.strip().split()[0] for line in content]
            filepaths += part_filepaths
        f.close()

    print(f"utk-face need process {len(filepaths)} images")

    folder_path = "/mnt/data/lanxing/UTK-face-wild/images"
    output_json_path = "face_detect_json_anno/UTK_face_wild_results.json"
    imgs_path = [os.path.join(folder_path, file) for file in filepaths]
