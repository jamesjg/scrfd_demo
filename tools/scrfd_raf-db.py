...
if __name__ == '__main__':
    ...
    file_txt = "/mnt/data/lanxing/RAF-DB/basic/EmoLabel/list_patition_label.txt"
    folder_path = "/mnt/data/lanxing/RAF-DB/basic/Image/original"
    output_json_path = "face_detect_json_anno/RAF-DB-Basic_results.json"
    imgs_path = []
    ...
    with open(file_txt, 'r') as f:
        ...
        for line in lines:
            ...
            assert os.path.exists(img_path), f"Error: {img_path} does not exist."
    ...
    with open(output_json_path, 'w') as json_file:
        ...
        for img_path in tqdm(imgs_path):
            ...
            img_name = img_path[len(folder_path)+1:]
