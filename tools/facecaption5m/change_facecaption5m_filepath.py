...
root = 'face_detect_json_anno/faceCaption5M_219k'


json_file = os.path.join(root, 'faceCaption5M_219k.json')
new_json_file = os.path.join(root, 'faceCaption5M_219k_new.json')
