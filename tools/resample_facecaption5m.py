...
resampled_data = []
face_num_total_dict = {"1":2144651, "2":483965, "3":125803, "4":63616}
...
new_json_path = os.path.join('face_detect_json_anno', f'{dataset}_219k', f'{dataset}_219k.json')
